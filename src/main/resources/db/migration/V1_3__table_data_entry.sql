...
INSERT INTO Users(user_id, first_name, last_name, mobile_number, password,otp, otp_generation_time, user_role, part_id, constituency_id, district_id) VALUES
    ...
    (4,'Barbaraanne','Karleman',1111111114,'$2a$10$s6SWT2GHCs675afbyBUdu.5AgibRl4EgPTDWKKXmZck4DhhDig29W', '000000','1970-01-01 00:00:01','BLO','4','2','1'),
    (5,'Renee','Menzies',1111111115,'$2a$10$s6SWT2GHCs675afbyBUdu.5AgibRl4EgPTDWKKXmZck4DhhDig29W', '000000','1970-01-01 00:00:01','BLO','5','2','1'),
    (6,'Beulah','Samsin',6305605268,'$2a$10$s6SWT2GHCs675afbyBUdu.5AgibRl4EgPTDWKKXmZck4DhhDig29W', '000000','1970-01-01 00:00:01','BLO','6','21','2'),
    (7,'Yuvraj','Agrawal',7665553672,'$2a$10$s6SWT2GHCs675afbyBUdu.5AgibRl4EgPTDWKKXmZck4DhhDig29W', '000000','1970-01-01 00:00:01','BLO','7','21','2'),
    (8,'Sumana','Uppala',9550982484,'$2a$10$s6SWT2GHCs675afbyBUdu.5AgibRl4EgPTDWKKXmZck4DhhDig29W', '000000','1970-01-01 00:00:01','BLO','8','21','2'),
    (9,'Shivom','Aghalte',8669132952,'$2a$10$s6SWT2GHCs675afbyBUdu.5AgibRl4EgPTDWKKXmZck4DhhDig29W', '000000','1970-01-01 00:00:01','BLO','9','22','2'),
    (10,'Shivam','Jaiswal',9399545318,'$2a$10$s6SWT2GHCs675afbyBUdu.5AgibRl4EgPTDWKKXmZck4DhhDig29W', '000000','1970-01-01 00:00:01','BLO','10','22','2');
...
INSERT INTO Voter(list_sl_no, sl_no_in_part, epic_no, first_name, last_name, relative_first_name, relative_last_name, rln_type, gender, age, dob, c_house_no, district_id, district_name, constituency_id, constituency_name, part_id, part_name, section_no, pwd_yn, age_above_80_yn, category,is_eligible) VALUES
    ...
    (7,32,'RCA0377408','Chaitanya','Dessai','Krishna','Dessai','F','M',19,'2001-11-27',6,1,'North Goa',1, 'Mandrem',2,'Government Primary School\, Tiracol',1,'N','N', 'AVCO',true),
    (8,33,'MGX5455639','Savita','Dessai','Apa','Dessai','H','F',37,'1983-11-21',7,1,'North Goa',1, 'Mandrem',2,'Government Primary School\, Tiracol',1,'N','N', 'AVCO',true),
    (9,46,'RCA0201681','Ratan','Aguiar','Redio','Aguiar','F','F',58,'1900-01-01',9,1,'North Goa',1, 'Mandrem',3,'Government Primary School\, Tiracol',1,'N','N', 'AVCO',true),
    (10,47,'JFF2134658','Surekha','Aguiar','Ramdas','Aguiar','H','F',51,'1900-01-01',9,1,'North Goa',1, 'Mandrem',3,'Government Primary School\, Tiracol',1,'N','N', 'AVGE',false),
    (11,49,'RCA0200469','Padmavati','Almedia','Nagu','Almedia','H','F',71,'1900-01-01',10,1,'North Goa',1, 'Mandrem',6,'Government Primary School Talwada Querim',1,'Y','N','AVPD',false),
    (12,63,'RCA0370304','Satywati','Serrao','Sagun','Serrao','H','F',71,'1900-01-01',12,1,'North Goa',1, 'Mandrem',6,'Government Primary School Talwada Querim',1,'Y','N','AVPD',false),
    (13,64,'JFF1205186','Sunil','D''Souza','Sagun','D''Souza','F','M',42,'1900-01-01',12,1,'North Goa',1, 'Mandrem',6,'Government Primary School Talwada Querim',1,'N','N', 'AVGE',false),
    (14,65,'JFF1205202','Sandesh','D''Souza','Sagun','D''Souza','F','M',39,'1900-01-01',12,1,'North Goa',1, 'Mandrem',7,'Government Primary School Talwada Querim',1,'N','N', 'AVGE',false),
    (15,66,'RCA0281998','Laxmi','D''Souza','Sunil','D''Souza','H','F',32,'1988-07-21',12,1,'North Goa',1, 'Mandrem',7,'Government Primary School Talwada Querim',1,'N','N', 'AVEW',false),
    (16,80,'RCA0263046','Jaiwant','Naik','Arjun','Naik','F','M',27,'1993-01-21',14,1,'North Goa',1, 'Mandrem',7,'Government Primary School Talwada Querim',1,'N','N', 'AVEW',false),
    (17,81,'RCA0294769','Pratiksha','Naik','Arjun','Naik','F','F',25,'1995-04-18',14,1,'North Goa',1, 'Mandrem',8,'Government Primary School Talwada Querim',1,'N','N', 'AVEW',false),
    (18,82,'RCA0370247','Yamuna','Naik','Raghunath','Naik','H','F',74,'1900-01-01',15,1,'North Goa',1, 'Mandrem',8,'Government Primary School Talwada Querim',1,'N','Y', 'AVSC',false),
    (19,83,'RCA0370395','Prakash','Naik','Raghunath','Naik','F','M',51,'1900-01-01',15,1,'North Goa',1, 'Mandrem',8,'Government Primary School Talwada Querim',1,'Y','N', 'AVPD',false),
    (20,97,'RCA0321489','Gajain','Rodrigues','Vishwas','Antao Dos Reis','F','M',20,'2000-11-14',19,1,'North Goa',9, 'Mandrem',2,'Government Primary School Talwada Querim',1,'N','N', 'AVGE',false),
    (21,399,'JFF0030197','Lilawati','Mascarenhas','Topiyo','Mascarenhas','H','F',82,'1900-01-01',83,1,'North Goa',10, 'Mandrem',2,'Government Primary School Talwada Querim',4,'N','Y','AVSC',true);
